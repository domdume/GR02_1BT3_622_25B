...
public class LogroRachaServiceNoDuplicadosTest {
    ...
    public void dado_RachaAlcanzaHito_Cuando_MiembroYaTieneLogro_Entonces_NoOtorgaLogroDuplicado() {
        ...
        Optional<String> msg3 = service.verificarYAsignar(miembroId, 3);
        ...
        when(achievementRepository.tieneLogro(miembroId, LogroRachaService.LOGRO_RACHA_7)).thenReturn(true);
        Optional<String> msg7 = service.verificarYAsignar(miembroId, 7);
        ...
        verify(achievementRepository, never()).guardarLogro(miembroId, LogroRachaService.LOGRO_RACHA_7);
